...
{
	public class SkillMinMaxRangeAttribute : PropertyAttribute
	{
		public SkillMinMaxRangeAttribute() { }
	}
...
namespace MyBox.Internal
{
	...
	[CustomPropertyDrawer(typeof(SkillMinMaxRangeAttribute))]
	public class MinMaxRangeIntAttributeDrawer : PropertyDrawer
	{
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			SkillMinMaxRangeAttribute rangeAttribute = (SkillMinMaxRangeAttribute) attribute;
